...
description: "Reference for all 22 built-in native functions."
---

Achronyme provides 22 native functions built into the VM. Some are also available in circuit mode.
