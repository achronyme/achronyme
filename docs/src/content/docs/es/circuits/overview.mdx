...
El bloque `prove` captura variables del ámbito, compila el cuerpo como un circuito vía ProveIR en tiempo de compilación, y genera una prueba en tiempo de ejecución. Las variables marcadas como `Public` son entradas públicas; las demás variables del ámbito externo se infieren automáticamente como testigos privados.
