...
Anotar un testigo como `Bool` ahorra 1 restriccion al omitir la verificacion booleana. Consulta [Anotaciones de Tipo](/es/circuits/type-annotations/) para detalles completos.
