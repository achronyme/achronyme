...
Consulta [Métodos y Namespaces Estáticos](/es/language/methods/#list) para la referencia completa.
...
Consulta [Métodos y Namespaces Estáticos](/es/language/methods/#map) para la referencia completa.
