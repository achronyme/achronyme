...
| Bandera | Descripción |
|------|-------------|
| `--error-format <fmt>` | Formato de salida de diagnósticos: `human` (predeterminado), `json`, o `short`. Ver [Diagnósticos y Advertencias](/es/language/diagnostics/#formatos-de-salida) |
...
Consulta [Opciones de Circuito](/es/cli/circuit-options) para todas las banderas disponibles.
