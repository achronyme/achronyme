...
//! - [`subprogram_lift`] — the multi-subprogram lift driver: the entry
//!   subprogram walk plus per-callee subprogram reservation and drain.
//!
//! ## Supported surface
//!
...
pub fn lift_function_to_artik(
    ...
    subprogram_lift::try_lift_via_subprograms(function_name, params, param_consts, body, ctx, span)
}
