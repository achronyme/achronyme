...
//!
//! These intentionally avoid any field-backend generics so the parent
//! compiler (the Achronyme `compiler` crate) can hold them in shared
//! state without monomorphization.
...
mod tests {
    ...
    fn dimension_expr_variants() {
        ...
        let e = DimensionExpr::Expr(Box::new(ast::Expr::Number {
            value: "1".into(),
            span: super::super::test_support::dummy_span(),
        }));
