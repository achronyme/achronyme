...
fn ecdsa_verify_boss_fight() {
    ...
    let t3 = Instant::now();
    let mut rc = R1CSCompiler::<Bn254Fr>::new();
    rc.compile_instructions(ir_forge::lysis_sink_instruction_stream(bundle.sink))
